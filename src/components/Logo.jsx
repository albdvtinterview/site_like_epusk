...
export function Logo({ light = false }) {
  if (!light) {
    return (
      <a href="#top" className="group shrink-0" aria-label="НоваЭнерго — на главную">
        <img
  ...
  return (
    <a href="#top" className="group flex items-center gap-3" aria-label="НоваЭнерго — на главную">
      <img
        src={assetUrl('images/brand/nova-energo-mark.png')}
        alt=""
        width="1254"
        height="1254"
        className="h-14 w-14 shrink-0 object-contain transition-transform group-hover:-rotate-3"
      />
