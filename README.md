...
Готовый файл появится в `release/energopusk-reg-ru.zip`. Загрузите его в корневой каталог сайта и распакуйте там. В архив не попадают исходники, `.env`, `server`, `node_modules` или Docker-конфиги.
